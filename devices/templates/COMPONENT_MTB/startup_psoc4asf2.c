...
void msc_interrupt_lp_IRQHandler        (void) __attribute__ ((weak, alias("Default_Handler"))); /* MSCv3LP interrupt */
void cpuss_interrupt_spcif_IRQHandler   (void) __attribute__ ((weak, alias("Default_Handler"))); /* SPCIF interrupt */
void msc_interrupt_IRQHandler           (void) __attribute__ ((weak, alias("Default_Handler"))); /* MSCv3 Interrupt */
...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    msc_interrupt_lp_IRQHandler,              /*   8 MSCv3LP interrupt */
    cpuss_interrupt_spcif_IRQHandler,         /*   9 SPCIF interrupt */
    msc_interrupt_IRQHandler,                 /*  10 MSCv3 Interrupt */
