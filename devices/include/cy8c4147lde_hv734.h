/***************************************************************************//**
* CY8C4147LDE-HV734 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C4147LDE_HV734_H_
#define _CY8C4147LDE_HV734_H_

/**
* \addtogroup group_device CY8C4147LDE-HV734
* \{
*/
...
typedef enum {
  ...
  /* CY8C4147LDE-HV734 Peripheral Interrupt Numbers */
  ...
  ioss_interrupts_gpio_2_IRQn       =   4,      /*!<   4 [DeepSleep] GPIO P2 */
  ioss_interrupts_gpio_3_IRQn       =   5,      /*!<   5 [DeepSleep] GPIO P3 */
  hvss_interrupt_hvss_IRQn          =   6,      /*!<   6 [DeepSleep] HVSS interface interrupt */
  scb_0_interrupt_IRQn              =   7,      /*!<   7 [DeepSleep] SCB #0 interrupt */
  scb_1_interrupt_IRQn              =   8,      /*!<   8 [DeepSleep] SCB #1 interrupt */
  isouart_interrupt_IRQn            =   9,      /*!<   9 [DeepSleep] isoUART interrupt */
  cpuss_interrupt_dma_IRQn          =  10,      /*!<  10 [Active] DMA Interrupt */
  cpuss_interrupt_spcif_IRQn        =  11,      /*!<  11 [Active] SPCIF interrupt */
  cpuss_interrupt_spcif1_IRQn       =  12,      /*!<  12 [Active] SPCIF interrupt, controller 1 */
  cpuss_interrupt_fault_0_IRQn      =  13,      /*!<  13 [Active] Fault structure 0 interrupt */
  cpuss_interrupt_fault_1_IRQn      =  14,      /*!<  14 [Active] Fault structure 1 interrupt */
  ...
  tcpwm_interrupts_4_IRQn           =  19,      /*!<  19 [Active] TCPWM #0, Counter #4 */
  pacss_interrupt_IRQn              =  20,      /*!<  20 [Active] PACSS consolidated interrupt */
  pacss_interrupts_dch_0_IRQn       =  21,      /*!<  21 [Active] PACSS digital channel #0 */
  pacss_interrupts_dch_1_IRQn       =  22,      /*!<  22 [Active] PACSS digital channel #1 */
  pacss_interrupts_dch_2_IRQn       =  23,      /*!<  23 [Active] PACSS digital channel #2 */
  pacss_interrupts_dch_3_IRQn       =  24,      /*!<  24 [Active] PACSS digital channel #3 */
  pacss_interrupt_mmio_IRQn         =  25,      /*!<  25 [Active] PACSS mmio */
  crypto_interrupt_IRQn             =  26,      /*!<  26 [Active] Crypto Interrupt */
  exco_interrupt_IRQn               =  27,      /*!<  27 [Active] EXCO Interrupt */
  canfd_interrupts0_0_IRQn          =  28,      /*!<  28 [Active] Canfd Int 0 for channel 0 */
  canfd_interrupts1_0_IRQn          =  29,      /*!<  29 [Active] Canfd Int 1 for channel 0 */
  lin_interrupts_0_IRQn             =  30,      /*!<  30 [Active] LIN interrupt, channel #0 */
  lin_interrupts_1_IRQn             =  31,      /*!<  31 [Active] LIN interrupt, channel #1 */
...
#define CY_FLASH1_SIZE                  0x00004000UL
#define CY_SFLASH1_BASE                 0x1FFFE000UL
#define CY_SFLASH1_SIZE                 0x00000400UL
#define CY_CAN0MRAM_BASE                0x40230000UL
#define CY_CAN0MRAM_SIZE                0x00010000UL


/* IP List */
#define CY_IP_M0S8TTCANFD               1u
#define CY_IP_M0S8TTCANFD_INSTANCES     1u
#define CY_IP_M0S8TTCANFD_VERSION       1u
...
#define CY_IP_M0S8ISOUART               1u
#define CY_IP_M0S8ISOUART_INSTANCES     1u
#define CY_IP_M0S8ISOUART_VERSION       1u
...
#define CY_DEVICE_PSOC4HVPAPPM
#define CY_DEVICE_SERIES_PSOC_4_HVPA_SPM_1_0
#define CY_SILICON_ID                   0x370511C7UL
#define CY_HF_CLK_MAX_FREQ              49152000UL


#include "system_cat2.h"

#include "psoc4hvpaspm10_config.h"
#include "gpio_psoc4hvpaspm10_48_qfn.h"
...
#define PERI_TR_GROUP6                          ((PERI_TR_GROUP_Type*) &PERI->TR_GROUP[6])                        /* 0x40012C00 */
...
#define EXCO_BASE                               0x400F0000UL
#define EXCO                                    ((EXCO_Type*) EXCO_BASE)                                          /* 0x400F0000 */
...
#define CANFD0_BASE                             0x40220000UL
#define CANFD0                                  ((CANFD_Type*) CANFD0_BASE)                                       /* 0x40220000 */
#define CANFD0_CH0                              ((CANFD_CH_Type*) &CANFD0->CH[0])                                 /* 0x40220000 */
#define CANFD0_CH0_M_TTCAN                      ((CANFD_CH_M_TTCAN_Type*) &CANFD0->CH[0].M_TTCAN)                 /* 0x40220000 */
...
#define ISOUART_BASE                            0x402E0000UL
#define ISOUART                                 ((ISOUART_Type*) ISOUART_BASE)                                    /* 0x402E0000 */
...
#define PACSS_MMIO_OCD_STRUCT0                  ((PACSS_MMIO_OCD_STRUCT_Type*) &PACSS->MMIO.OCD_STRUCT[0])        /* 0x403F0700 */
#define PACSS_MMIO_OCD_STRUCT1                  ((PACSS_MMIO_OCD_STRUCT_Type*) &PACSS->MMIO.OCD_STRUCT[1])        /* 0x403F0710 */

/** \} CY8C4147LDE-HV734 */

#endif /* _CY8C4147LDE_HV734_H_ */
