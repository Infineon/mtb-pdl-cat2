...
typedef enum
{
    ...
    P0_0_TCPWM_TR_IN0               =  8,       /* Digital Active - tcpwm.tr_in[0]:0 */
    ...
    P0_1_USBPD0_EXT_FEEDFWD_PRE_SW_EN = 11,     /* Digital Active - usbpd[0].ext_feedfwd_pre_sw_en:1 */
    ...
    P0_3_USBPD0_PTDRV_IN            = 13,       /* Digital Deep Sleep - usbpd[0].ptdrv_in:1 */
    P0_3_USBPD0_ADC_CMP_OUT_GPIO0   = 14,       /* Digital Deep Sleep - usbpd[0].adc_cmp_out_gpio[0]:1 */
    P0_3_USBPD0_EXT_GDRV_IN         = 15,       /* Digital Deep Sleep - usbpd[0].ext_gdrv_in:1 */
