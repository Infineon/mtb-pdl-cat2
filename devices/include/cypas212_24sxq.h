/***************************************************************************//**
* \file cypas212_24sxq.h
*
* \brief
* CYPAS212-24SXQ device header
*
********************************************************************************
* \copyright
...
#ifndef _CYPAS212_24SXQ_H_
#define _CYPAS212_24SXQ_H_

/**
* \addtogroup group_device CYPAS212-24SXQ
* \{
*/
...
typedef enum {
  ...
  /* CYPAS212-24SXQ Peripheral Interrupt Numbers */
...
#include "gpio_pag2s_24_soic_pwm.h"

#define CY_DEVICE_PAG2S
#define CY_DEVICE_SERIES_PAG2S
#define CY_SILICON_ID                   0x3B0111CBUL
