/***************************************************************************//**
* PSOC4HVPASPM10 device GPIO header for 48-QFN package
*
********************************************************************************
* \copyright
...
#ifndef _GPIO_PSOC4HVPASPM10_48_QFN_H_
#define _GPIO_PSOC4HVPASPM10_48_QFN_H_
...
/* Analog Connections */
#define PACSS_MUX_PADS0_PORT            2u
#define PACSS_MUX_PADS0_PIN             0u
#define PACSS_MUX_PADS1_PORT            2u
#define PACSS_MUX_PADS1_PIN             1u
#define PACSS_MUX_PADS2_PORT            2u
#define PACSS_MUX_PADS2_PIN             2u
#define PACSS_MUX_PADS3_PORT            2u
#define PACSS_MUX_PADS3_PIN             3u
#define PACSS_MUX_PADS4_PORT            2u
#define PACSS_MUX_PADS4_PIN             4u
#define PACSS_MUX_PADS5_PORT            2u
#define PACSS_MUX_PADS5_PIN             5u
#define PACSS_MUX_PADS6_PORT            2u
#define PACSS_MUX_PADS6_PIN             6u
#define PACSS_MUX_PADS7_PORT            2u
#define PACSS_MUX_PADS7_PIN             7u
#define PACSS_VTEMP_PORT                1u
#define PACSS_VTEMP_PIN                 2u
#define PACSS_VTEMP_RET_PORT            1u
#define PACSS_VTEMP_RET_PIN             1u
#define PACSS_VTEMP_RET_K_PORT          1u
#define PACSS_VTEMP_RET_K_PIN           1u
...
typedef enum
{
    ...
    P0_0_SCB0_UART_RX               = 10,       /* Digital Active - scb[0].uart_rx */
    P0_0_SCB0_SPI_CLK               = 12,       /* Digital Deep Sleep - scb[0].spi_clk */
    ...
    P0_1_SCB0_UART_TX               = 10,       /* Digital Active - scb[0].uart_tx */
    P0_1_TCPWM_LINE_COMPL4          = 11,       /* Digital Active - tcpwm.line_compl[4]:0 */
    P0_1_SCB0_SPI_MOSI              = 12,       /* Digital Deep Sleep - scb[0].spi_mosi */
    ...
    P0_2_LIN_LIN_RX0                = 10,       /* Digital Active - lin.lin_rx[0] */
    P0_2_TCPWM_LINE3                = 11,       /* Digital Active - tcpwm.line[3]:0 */
    P0_2_SCB0_SPI_MISO              = 12,       /* Digital Deep Sleep - scb[0].spi_miso */
    ...
    P0_3_LIN_LIN_TX0                = 10,       /* Digital Active - lin.lin_tx[0] */
    P0_3_TCPWM_LINE4                = 11,       /* Digital Active - tcpwm.line[4]:0 */
    ...
    P0_4_PACSS_OCD_OUT1             =  9,       /* Digital Active - pacss.ocd_out[1] */
    P0_4_LIN_LIN_EN0                = 10,       /* Digital Active - lin.lin_en[0] */
    P0_4_TCPWM_LINE_COMPL0          = 11,       /* Digital Active - tcpwm.line_compl[0]:0 */
    P0_4_SCB0_SPI_SELECT1           = 12,       /* Digital Deep Sleep - scb[0].spi_select1 */
    P0_4_SCB1_SPI_SELECT3           = 13,       /* Digital Deep Sleep - scb[1].spi_select3 */
    ...
    P0_5_LIN_LIN_RX1                = 10,       /* Digital Active - lin.lin_rx[1] */
    P0_5_TCPWM_LINE_COMPL1          = 11,       /* Digital Active - tcpwm.line_compl[1]:0 */
    P0_5_SCB0_SPI_SELECT2           = 12,       /* Digital Deep Sleep - scb[0].spi_select2 */
    P0_5_SCB1_SPI_SELECT2           = 13,       /* Digital Deep Sleep - scb[1].spi_select2 */
    ...
    P0_6_CANFD_TTCAN_TX0            =  9,       /* Digital Active - canfd.ttcan_tx[0]:1 */
    P0_6_LIN_LIN_TX1                = 10,       /* Digital Active - lin.lin_tx[1] */
    P0_6_TCPWM_LINE_COMPL2          = 11,       /* Digital Active - tcpwm.line_compl[2]:0 */
    P0_6_SCB0_SPI_SELECT3           = 12,       /* Digital Deep Sleep - scb[0].spi_select3 */
    P0_6_SCB1_SPI_SELECT1           = 13,       /* Digital Deep Sleep - scb[1].spi_select1 */
    ...
    P0_7_CANFD_TTCAN_RX0            =  9,       /* Digital Active - canfd.ttcan_rx[0]:1 */
    P0_7_LIN_LIN_EN1                = 10,       /* Digital Active - lin.lin_en[1] */
    P0_7_TCPWM_LINE_COMPL3          = 11,       /* Digital Active - tcpwm.line_compl[3]:0 */
    P0_7_SCB1_SPI_SELECT0           = 13,       /* Digital Deep Sleep - scb[1].spi_select0 */
    ...
    P3_0_PERI_VIRT_IN_3             =  8,       /* Digital Active - peri.virt_in_3 */
    P3_0_CANFD_TTCAN_TX0            =  9,       /* Digital Active - canfd.ttcan_tx[0]:0 */
    P3_0_SCB1_UART_TX               = 10,       /* Digital Active - scb[1].uart_tx */
    P3_0_TCPWM_LINE0                = 11,       /* Digital Active - tcpwm.line[0]:0 */
    P3_0_SCB1_SPI_CLK               = 13,       /* Digital Deep Sleep - scb[1].spi_clk:0 */

    /* P3.1 */
    P3_1_GPIO                       =  0,       /* SW controlled GPIO. */
    P3_1_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P3_1_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P3_1_CANFD_TTCAN_RX0            =  9,       /* Digital Active - canfd.ttcan_rx[0]:0 */
    P3_1_SCB1_UART_RX               = 10,       /* Digital Active - scb[1].uart_rx */
    P3_1_TCPWM_LINE1                = 11,       /* Digital Active - tcpwm.line[1]:0 */
    P3_1_SCB1_SPI_MOSI              = 13,       /* Digital Deep Sleep - scb[1].spi_mosi:0 */
    P3_1_SCB1_I2C_SDA               = 14,       /* Digital Deep Sleep - scb[1].i2c_sda */

    /* P3.2 */
    P3_2_GPIO                       =  0,       /* SW controlled GPIO. */
    P3_2_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P3_2_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P3_2_TCPWM_TR_IN4               =  8,       /* Digital Active - tcpwm.tr_in[4] */
    P3_2_PACSS_OCD_OUT0             =  9,       /* Digital Active - pacss.ocd_out[0] */
    P3_2_TCPWM_LINE2                = 11,       /* Digital Active - tcpwm.line[2]:0 */
    P3_2_SCB1_SPI_MISO              = 13,       /* Digital Deep Sleep - scb[1].spi_miso:0 */
    P3_2_SCB1_I2C_SCL               = 14        /* Digital Deep Sleep - scb[1].i2c_scl */
} en_hsiom_sel_t;

#endif /* _GPIO_PSOC4HVPASPM10_48_QFN_H_ */
