...
#ifndef _CYIP_SFLASH_PMG1S3_H_
#define _CYIP_SFLASH_PMG1S3_H_
...
typedef struct {
  ...
  __IOM uint8_t  INITIAL_SPCIF_TRIM_M1_DAC0;    /*!< 0x00000255 FLASH IDAC trim used during boot */
