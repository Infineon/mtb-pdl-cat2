...
static void Cy_USBPD_BB_VregInrushDetEnCb( cy_en_usbpd_timer_id_t id, void *context)
{
    ...
    else
    {
        ...
        usbpd_ctx->timerStartcbk(usbpd_ctx, usbpd_ctx, CY_USBPD_APP_HAL_VREG_TIMER,
...
static void Cy_USBPD_BB_SoftStartDoneCbk(cy_en_usbpd_timer_id_t id, void *usbpdContext)
{
    ...
    context->timerStopcbk(context, CY_USBPD_APP_REGULATOR_STARTUP_MONITOR_TIMER);
...
static void Cy_USBPD_BB_SetVsafe5vDone(void *context, bool stat)
{
    ...
    (void)usbpd_ctx->timerStartcbk(usbpd_ctx, usbpd_ctx, CY_USBPD_APP_HAL_GENERIC_TIMER, BB_STARTUP_DONE_TIMER_PERIOD_MS, Cy_USBPD_BB_SoftStartDoneCbk);
}
...
static bool bb_en_vbus_ovp_cbk(void *context, bool comp_out)
{
    ...
    if (comp_out == true)
    {
        ...
        /* Enable EA mode */
        bb_soft_start_to_ea_cb(CY_USBPD_APP_HAL_GENERIC_TIMER, usbpd_ctx);
    }
...
static void bb_safe_vbus_in_cb(cy_en_usbpd_timer_id_t id, void *callbackContext)
{
    ...
    else
    {
        ...
        context->timerStopcbk(context, CY_USBPD_APP_HAL_GENERIC_TIMER);
...
static void bb_soft_start_mon_cb(cy_en_usbpd_timer_id_t id, void *callbackContext)
{
    ...
    context->timerStartcbk(context, context, CY_USBPD_APP_HAL_GENERIC_TIMER,
