...
* into all MSCLP HW block registers.
*
...
****************************************************************************//**
*
* Sets configuration of the MSCLP HW block registers at once.
*
* This function writes configuration data into all MSCLP block registers
* (except read-only registers and command registers) at once.
*
* \param base
* The pointer to a MSCLP HW block base address.
*
...
*                            CY_MSCLP_MRSS_TIMEOUT_SMALL macros
*
*******************************************************************************/
...
* \ref CY_MSCLP_5_SNS_REGS is also supported.
*
* \param scanConfig
