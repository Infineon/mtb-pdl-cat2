...
#if ((defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)) && (VBUS_IN_DISCHARGE_EN))
...
#endif /* ((defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S))&& (VBUS_IN_DISCHARGE_EN)) */
...
#endif /* !(defined(CCG7D) || defined(CCG7S)) */
        ...
        cy_en_pd_rp_term_t rpVal)
{
    ...
    uint8_t cc_trim = 0;
#endif /* (defined(CY_DEVICE_CCG6) || defined(CY_DEVICE_PMG1S3) || defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)) */
        ...
        bool flag)
{
    ...
    else
    {
        ...
        pd->refgen_0_ctrl |= (PDSS_REFGEN_0_CTRL_REFGEN_VREFIN_SEL |
            PDSS_REFGEN_0_CTRL_REFGEN_VREFIN_MON_SEL);
#endif /* CY_DEVICE_CCG7D || defined(CY_DEVICE_CCG7S) */
    }
#else
    CY_UNUSED_PARAMETER(context);
...
#elif ((defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)) && (!QC_AFC_CHARGING_DISABLED))
