...
cy_en_usbpd_status_t Cy_USBPD_Bch_QcSrcContModeStart(cy_stc_usbpd_context_t *context)
{
...
#if (defined(CY_DEVICE_PMG1S3) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S))
...
#endif /* (defined(CY_DEVICE_PMG1S3) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)) */    
    ...
    *afc_hs_filter_cfg = regval;
    ...
    CY_UNUSED_PARAMETER(context);
    return CY_USBPD_STAT_NOT_SUPPORTED;
#endif /* (defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG6) || defined(CY_DEVICE_PMG1S3) (defined(CY_DEVICE_PMG1S3) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)))  */
}
...
cy_en_usbpd_status_t Cy_USBPD_Bch_QcSrcContModeStop(cy_stc_usbpd_context_t *context)
{
    ...
    CY_UNUSED_PARAMETER(context);
    return CY_USBPD_STAT_NOT_SUPPORTED;
#endif /* (defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG6) || defined(CY_DEVICE_PMG1S3) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S))  */
}
...
#if (defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S) || defined(CY_DEVICE_PMG1S3))
...
#if (BCR == 1) && (AFC_PARITY_CHECK_ENABLE)
        else if(((pd->afc_sm_status[chgb_id] & PDSS_AFC_SM_STATUS_MASTER_PARITY_ERROR_STATUS_MASK)
             >> PDSS_AFC_SM_STATUS_MASTER_PARITY_ERROR_STATUS_POS) )
        {
                context->bcAfcRxIdx =0;
        }
#endif /* (BCR == 1) && (AFC_PARITY_CHECK_ENABLE) */
    else
    {
        /* RX going on */
        ...
        if(context->bcAfcRxIdx < AFC_MAX_BYTES)            
#if BCR
               && context->bcAfcRxIdx < (PDSS->afc_sm_status[chgb_id] &
