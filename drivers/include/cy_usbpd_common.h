...
#if (((defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG3PA2) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)) && defined(CCG_CDP_EN)) && BATTERY_CHARGING_ENABLE)
...
#endif /* (((defined(CY_DEVICE_CCG3PA) || defined(CY_DEVICE_CCG3PA2) || defined(CY_DEVICE_CCG7D) || defined(CY_DEVICE_CCG7S)) && CCG_CDP_EN) && BATTERY_CHARGING_ENABLE) */
